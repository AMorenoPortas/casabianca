    ...
    >
      ...
      <section id="inicio" className="relative overflow-hidden">
        <div className="mx-auto max-w-4xl px-6 pt-12 pb-28 text-center md:pt-16 md:pb-36">
          ...
          <p className="mb-6 text-xs uppercase tracking-[0.4em] text-[#A6896F]">
            Don Torcuato · Blanqueria & Accesorios
          </p>
          ...
          <p
            ...
            style={{ color: "var(--muted)" }}
          >
            Desde un juego de sábanas hasta un artículo de diseño tenemos el
            detalle perfecto para renovar tu energía y tu hogar.
          </p>
          ...
          <div className="mt-4 flex justify-center">
            <a
              href="/filosofia"
              className="rounded-full border border-[#D8CCB6] px-8 py-3 text-sm tracking-wide transition-colors hover:border-[#A6896F] hover:text-[#A6896F]"
              style={{ color: "var(--muted)" }}
            >
      ...
      >
        <div className="mx-auto max-w-6xl px-6 py-24">
          ...
          <div
            className="mt-14 grid gap-px overflow-hidden rounded-2xl md:grid-cols-3"
            style={{
          ...
          >
            {[
              ...
              },
              {
                icon: <IconTrato />,
                t: "Trato Cordial",
                d: "Me gusta conocer a mis clientas. Para mí, cada consulta es la oportunidad de crear un vínculo sincero; 20 años de comercializar en la zona avalan esta teoría.",
              },
            ].map((c) => (
              <div
                key={c.t}
      ...
      >
        <div className="mx-auto max-w-6xl px-6 py-24">
          ...
          <p
            ...
            style={{ color: "var(--muted)" }}
          >
            Más allá de los productos, te acompañamos en la transformación de
            tus espacios. Desde la confección a medida hasta el asesoramiento
            profesional, cada detalle cuenta.
          </p>
          ...
          <div className="mt-16">
            ...
            <p
              ...
              style={{ color: "var(--muted)" }}
            >
              Cortinas, almohadones, cubrecamas y más, diseñados exactamente
              para tu espacio. Elegís la tela, nosotros le damos forma.
            </p>
            ...
            >
              <div className="p-10 md:p-14">
                ...
                <p
                  ...
                  style={{ color: "var(--muted)" }}
                >
                  Desde elegir la paleta de colores hasta definir texturas y
                  materiales, mi mirada profesional está disponible para
                  ayudarte a crear el ambiente que siempre soñaste. Consultas
                  presenciales en el local o por WhatsApp.
                </p>
                <a
                  href="https://wa.me/541141952834"
                  target="_blank"
                  rel="noreferrer"
                  className="mt-8 inline-block self-start rounded-full bg-[#2E2A24] px-7 py-3 text-sm text-[#F7F3EC] transition-transform hover:-translate-y-0.5"
                >
                  Consultar ahora
                </a>
              </div>
      ...
      >
        <div className="mx-auto max-w-5xl px-6 py-24">
          ...
          <p
            ...
            style={{ color: "var(--muted)" }}
          >
            Vestir tu hogar es una decisión personal y, a veces, técnica. Por
            eso armé este espacio de consulta rápida: mi guía sobre la calidad
            de los hilados, tips para combinar texturas y una tabla de medidas
            exacta para que tus sábanas y acolchados queden impecables.
          </p>
            ...
            <tbody>
              {MEDIDAS.map((m, i) => (
                <tr
                  key={m.talle}
                  style={{
                    background: i % 2 ? "var(--surface)" : "var(--background)",
                  }}
                >
